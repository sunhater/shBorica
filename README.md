...
На банката се изпращат:
* Генерираните заявки за сертификат (`V1234567_20201028_D.csr` и `V1234567_20201028_P.csr`).
* URL адрес на който системата ще връща отговори от извършените операции.
...
И настройките и стойностите по подразбиране си имат съответни полета в класа (`$config` и `$defaults`). Възможно е разширяване на тези полета, така, че при създаване на инстанция да подавам минимален брой елементи или дори нищо.
